# discord-audio-pipe
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/QiCuiHub/discord-audio-pipe)](https://github.com/jjwfisher/discord-audio-pipe/releases/latest)
